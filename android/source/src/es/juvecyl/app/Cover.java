...
public class Cover extends SherlockActivity implements ShowcaseView.OnShowcaseEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // //////////////////////////////////////////////////////////////////////////
        navToggle = new ActionBarDrawerToggle(this, drawerLayout, R.drawable.ic_drawer,
                ...
                public void run() {
                    Cover.this.runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            mViews = new ShowcaseViews(
                                    Cover.this, R.layout.first_run_layout,
                                        ...
                                        public void onShowCaseAcknowledged(ShowcaseView showcaseView) {
                                            ...
                                            buttonPull.setOnClickListener(new OnClickListener() {
                                                ...
                                                public void onClick(View arg0) {
                                                    Intent intent = new Intent(Cover.this,
                                                            Main.class);
                                                    Bundle b = new Bundle();
                                                    b.putString(
                                                            "province",
                            ...
                            mViews.addView(new ShowcaseViews.ItemViewProperties(android.R.id.home,
                                    R.string.tutorial_title, R.string.tutorial_message2, 1.0f));
                            mViews.show();
                        }
                    });
